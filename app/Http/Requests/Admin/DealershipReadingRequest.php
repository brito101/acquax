...
class DealershipReadingRequest extends FormRequest
{
    ...
    protected function prepareForValidation()
    {
        $this->merge([
            ...
            'minimum_value'  => $this->minimum_value ? str_replace(',', '.', str_replace('.', '', str_replace('R$ ', '', $this->minimum_value))) : 0,
            ...
            'dealership_cost_tax_1' => $this->dealership_cost_tax_1 ? str_replace(',', '.', str_replace('.', '', str_replace('R$ ', '', $this->dealership_cost_tax_1))) : 0,
    ...
    public function rules()
    {
        return [
            ...
            'dealership_cost_tax_1' => 'nullable|numeric|between:0,999999999.999',
            ...
            'consumption_calculation' => 'nullable|min:1|max:20|in:Consumo Real,Consumo com Mínimo,Consumo sem Mínimo',
            'type_minimum_value' => 'nullable|min:1|max:20|in:Da Concessionária,Pré Estabelecido',
            'minimum_value' => 'nullable|numeric|between:0,999999999.999',
            'fare_type'  => 'nullable|min:1|max:191|in:Concessionária com 2ª faixa pela Progressividade,Concessionária com 2ª faixa pela Média,Metro Cúbico Médio',
            'common_area'  => 'nullable|min:1|max:20|in:Sem,Simples,Fração',
            ...
            'consumption_ranges' => 'nullable|integer|min:1|max:6',
