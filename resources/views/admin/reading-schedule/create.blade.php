...
@section('title', '- Cadastro de Agendamento de Leitura')
...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-fw fa-calendar-check"></i> Novo Agendamento</h1>
                </div>
                <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <form method="POST" action="{{ route('admin.reading-schedule.store') }}">
                            @csrf
                            <div class="card-body">
                                <input type="hidden" name="title" value="Agendamento de leitura">
