...
@section('title', '- Cadastro de Consumo de Gás de Condomínio')
...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-fw fa-chart-bar"></i> Novo Consumo de Gás</h1>
                </div>
                <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <form method="POST" action="{{ route('admin.dealerships-readings-gas.store') }}">
                            @csrf
