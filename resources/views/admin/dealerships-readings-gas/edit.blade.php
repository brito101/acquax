...
@section('title', '- Edição de Consumo de Gás do Condomínio')
...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-fw fa-chart-bar"></i> Editar Consumo de Gás</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">Home</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('admin.dealerships-readings-gas.index') }}">Consumo de
                                Gás
                                dos
                                Condomínios</a>
                        </li>
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Dados Cadastrais de Consumo de Gás</h3>
                        ...
                        <form method="POST"
                            action="{{ route('admin.dealerships-readings-gas.update', ['dealerships_readings_ga' => $reading->id]) }}">
                            @method('PUT')
                            @csrf
