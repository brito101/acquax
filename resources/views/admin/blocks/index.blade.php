                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        @php
                            ...
                            $config = [
                                'ajax' => url('/admin/blocks?complex=' . $filter),
                                'columns' => [['data' => 'id', 'name' => 'id'], ['data' => 'name', 'name' => 'name'], ['data' => 'complex', 'name' => 'complex'], ['data' => 'status', 'name' => 'status'], ['data' => 'action', 'name' => 'action', 'orderable' => false, 'searchable' => false]],
                        ...
                        <div class="card-body pb-0">
                            <div class="px-2 col-12">
                                <form method="POST" action="{{ route('admin.blocks.batchDelete') }}"
