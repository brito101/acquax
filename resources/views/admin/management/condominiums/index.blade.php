...
@section('title', '- Gerencial: Lista de Condomínios')
...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-fw fa-building"></i> Lista de Condomínios</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">Home</a></li>
                        <li class="breadcrumb-item active">Lista de Condomínios</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        @php
                            $heads = ['Condomínios', 'Blocos', 'Apartamentos'];
                            $config = [
                                'ajax' => url('/admin/management-reports-condominiums'),
                                'columns' => [['data' => 'complex_name', 'name' => 'complex_name'], ['data' => 'block_name', 'name' => 'block_name'], ['data' => 'apartment_name', 'name' => 'apartment_name']],
                                'rowGroup' => ['dataSrc' => 0],
