...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-fw fa-list-ul"></i> Editar Relatório</h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <small class="float-right text-black-50">Criado por {{ $report->user->name }} em
                                {{ date('d/m/Y H:i', strtotime($report->created_at)) }}</small>
                        </div>
                                ...
                                <div class="d-flex flex-wrap justify-content-between">
                                    <div class="col-12 col-md-6 form-group px-0 pr-md-2 mb-0">
                                        ...
                                        <x-adminlte-select2 name="dealership_reading_id">
                                            @foreach ($dealershipReadings as $dealershipReading)
                                                <option
                                                    {{ old('dealership_reading_id ') == $dealershipReading->id ? 'selected' : ($report->dealership_reading_id == $dealershipReading->id ? 'selected' : '') }}
                                    ...
                                    <div class="col-12 col-md-3 form-group px-0 px-md-2">
                                        ...
                                        <input type="text" class="form-control" id="block"
                                            placeholder="Nome do bloco" name="block"
                                            value="{{ old('block') ?? $report->apartment->block_name }}" required>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-3 form-group px-0 pl-md-2">
                                        ...
                                        <input type="text" class="form-control" id="apartment"
                                            ...
                                            value="{{ old('apartment') ?? $report->apartment->name }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex flex-wrap justify-content-between">
                                    <div class="col-12 col-md-4 form-group px-0 pr-md-2">
                                        ...
                                        <input type="text" class="form-control" id="consumed"
                                            ...
                                            value="{{ old('consumed') ?? $report->consumed }}" required>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-4 form-group px-0 px-md-2">
                                        ...
                                        <input type="text" class="form-control money_format_3" id="consumed_cost"
                                            ...
                                            value="{{ old('consumed_cost') ?? $report->consumed_cost }}" required>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-4 form-group px-0 pl-md-2">
                                        ...
                                        <input type="text" class="form-control money_format_3" id="sewage_cost"
                                            ...
                                            value="{{ old('sewage_cost') ?? $report->sewage_cost }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex flex-wrap justify-content-between">
                                    <div class="col-12 col-md-4 form-group px-0 pr-md-2">
                                        ...
                                        <input type="text" class="form-control" id="kite_car_consumed"
                                            ...
                                            value="{{ old('kite_car_consumed') ?? $report->kite_car_consumed }}">
                                    </div>
                                    ...
                                    <div class="col-12 col-md-4 form-group px-0 px-md-2">
                                        ...
                                        <input type="text" class="form-control money_format_3" id="kite_car_cost"
                                            ...
                                            value="{{ old('kite_car_cost') ?? $report->kite_car_cost }}">
                                    </div>

                                    <div class="col-12 col-md-4 form-group px-0 pl-md-2">
                                        <label for="partial">Rateio Proporcional</label>
                                        <input type="text" class="form-control money_format_3" id="partial"
                                            placeholder="Custo em reais" name="partial"
                                            value="{{ old('partial') ?? $report->partial }}">
                                    </div>
                                ...
                                <div class="d-flex flex-wrap justify-content-start">
                                    ...
                                    <div class="col-12 col-md-4 form-group px-0 pr-md-2">
                                        ...
                                        <input type="text" class="form-control" id="partial"
                                            ...
                                            value="{{ old('total_consumed') ?? $report->total_consumed }}" required>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-4 form-group px-0 px-md-2">
                                        ...
                                        <input type="text" class="form-control money_format_3" id="total_unit"
                                            ...
                                            value="{{ old('total_unit') ?? $report->total_unit }}" required>
                                    </div>
                                ...
                                <div class="d-flex flex-wrap justify-content-start">
                                    ...
                                    <div class="col-12 col-md-4 form-group px-0 pr-md-2">
                                        ...
                                        <input type="text" class="form-control" id="consumption_gas_value"
                                            ...
                                            value="{{ old('consumption_gas_value') ?? $report->consumption_gas_value }}">
                                    </div>
                                    ...
                                    <div class="col-12 col-md-4 form-group px-0 px-md-2">
                                        ...
                                        <input type="text" class="form-control money_format_2" id="total_gas_value"
                                            ...
                                            value="{{ old('total_gas_value') ?? $report->total_gas_value }}">
                                    </div>
