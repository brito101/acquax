...
@section('title', '- Cadastro de Concessionária')
...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-fw fa-hands-helping"></i> Nova Concessionária</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Nova Concessionária</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <form method="POST" action="{{ route('admin.dealerships.store') }}">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-wrap justify-content-between">
                                    ...
                                    <div class="col-12 col-md-6 form-group px-0 pl-md-2 mb-0">
                                        ...
                                        <x-adminlte-select2 name="service">
                                            <option {{ old('service') == 'Água e Esgoto' ? 'selected' : '' }}>Água e
                                                Esgoto</option>
                                            <option {{ old('service') == 'Gás' ? 'selected' : '' }}>Gás</option>
                                        </x-adminlte-select2>
                                    </div>
                                </div>
