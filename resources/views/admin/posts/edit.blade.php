                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-wrap justify-content-between">
                                    <div class="col-12 col-md-6 form-group px-0 pr-md-2">
                                        ...
                                        <input type="text" class="form-control" id="title"
                                            placeholder="Título do Post" name="title"
                                ...
                                @if ($post->cover)
                                    <div class="col-12 img-responsive-16by9 text-center shadow-lg mb-2">
                                        <img src="{{ Storage::url('posts/' . $post->cover) }}" class="radius" alt=""
                                            width="100%" style="max-height: 500px; object-fit: cover">
                                    </div>
                                @endif
                                ...
                                <div class="d-flex flex-wrap justify-content-between">
                                    <div class="col-12 col-md-4 form-group px-0 pr-md-2">
                                        ...
                                        <x-adminlte-select2 name="status">
                                            <option
                                                {{ old('status') == 'Publicado' ? 'selected' : ($post->status == 'Publicado' ? 'selected' : '') }}>
                                                Publicado
                                            </option>
                                            <option
